...
import { addContact, getAllContacts } from "@/apis/apiContact";
...
export default function AddContactScreen() {
  ...
  const { mutate: addContactMutation } = useMutation({
    mutationFn: (formData: ContactFormData) => addContact(formData),
  ...
  const handleSubmit = () => {
    ...
    const existingContact = contactsQuery.find(
      (contact: Contact) => contact.phone === inputValue.phone
    );
